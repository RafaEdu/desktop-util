...
export function SnippetManager() {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      <div className="px-4 pt-3 pb-3 flex items-center justify-end border-b border-edge">
        <button
          onClick={() => startEdit()}
          className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-md text-xs font-medium text-fg-4 hover:text-white hover:bg-field transition-colors"
      ...
      {isEditing && (
        <div className="px-4 pt-3 pb-3 bg-surface/50 border-b border-edge">
          <h3 className="text-xs font-medium text-fg-5 uppercase mb-2">
          ...
          <div className="space-y-2">
            ...
            />
            <textarea
              className="w-full h-28 resize-none bg-field border border-edge-2 rounded-lg px-3 py-2 text-sm text-fg placeholder-fg-5 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200"
            ...
            <div className="flex justify-end gap-2">
              <button
                ...
                className="px-3 py-1.5 rounded-md text-xs font-medium text-fg-4 hover:text-fg-2 hover:bg-field transition-colors"
              >
                Cancelar
              </button>
              <button
              ...
              >
                <div className="flex items-start justify-between gap-2">
                  ...
                  >
                    ...
                    <p className="text-xs text-fg-5 mt-0.5 line-clamp-2 font-mono">
                      {snippet.content}
                    </p>
                  </button>
